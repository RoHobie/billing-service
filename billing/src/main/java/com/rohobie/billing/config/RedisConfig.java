 ...
 * RedisConfig
 *
 * Configures Redis-backed caching for frequently queried fleet and billing data.
 * Implements a resilient CacheErrorHandler that guarantees graceful degradation:
 * if the Redis cluster is unreachable, queries seamlessly fall back to database retrieval.
 *
